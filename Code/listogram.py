...
class Listogram(list):
    ...
    def add_count(self, word, count=1):
        ...
        # See if the word already has an entry
    ...
    def sample(self):
        ...
        # Draw a random "dart" between 1 and total tokens
        ...
        # Fallback: choose a random word uniformly if something goes wrong
        return random.choice([word for word, _ in self])
